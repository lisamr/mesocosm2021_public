...
fit3 <- update(fit1, formula. = bf3, newdata = merged, save_pars = save_pars(all = TRUE))
fit4 <- update(fit1, formula. = bf4, newdata = merged, save_pars = save_pars(all = TRUE))
fit5 <- update(fit1, formula. = bf5, newdata = merged, save_pars = save_pars(all = TRUE))
...
expose_functions(fit1, vectorize = T)
