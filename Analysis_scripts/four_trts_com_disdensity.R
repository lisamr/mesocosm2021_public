# TOTAL NUMBER OF DISEASED INDIV. vs. richness across the four treatments
...
write_csv(post_ALL, file = 'Outputs/four_trts_numdis.csv')
...
plot_grid(
  ...
  draw_label('Total number of diseased plants', x = .01, y = .5, angle = 90, size = 11)
ggsave('Figures/four_trts_comm_dens.pdf', device = 'pdf', units = 'mm', width = 181, height = 100)
